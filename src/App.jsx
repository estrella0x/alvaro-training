    ...
    <div style={{display:"flex",gap:5,marginBottom:10}}>
      {labels.map((label,i)=>{
        ...
        return <button key={n} onClick={()=>onSave({...sleepData,rating:active?0:n})}
          style={{flex:1,minWidth:0,background:active?C.text:C.bg,border:`1px solid ${active?C.text:C.border}`,borderRadius:8,padding:"8px 2px",cursor:"pointer"}}>
          <p style={{color:active?C.bg:C.textMuted,fontSize:10,margin:0,fontWeight:active?500:400,textAlign:"center"}}>{label}</p>
        </button>;
      })}
    </div>
    <div style={{display:"flex",gap:8,alignItems:"center"}}>
      ...
      <input
        ...
        placeholder="7.5"
        inputMode="decimal"
        style={{flex:1,minWidth:0,boxSizing:"border-box",background:C.bg,border:`1px solid ${C.border}`,borderRadius:8,color:C.text,padding:"4px 6px",outline:"none",WebkitAppearance:"none",fontFamily:"inherit"}}
      />
          ...
          ?<div style={{marginTop:8,width:"100%",boxSizing:"border-box",background:C.surface,borderRadius:8,padding:"10px",border:`1px solid ${C.border}`}}>
             ...
             <div style={{display:"flex",alignItems:"center",gap:8,marginBottom:newSupIsProtein?8:10}}>
               ...
               <button onClick={()=>setNewSupIsProtein(v=>!v)}
                 style={{background:newSupIsProtein?C.text:C.bg,border:`1px solid ${newSupIsProtein?C.text:C.border}`,borderRadius:6,color:newSupIsProtein?C.bg:C.textMuted,padding:"4px 12px",cursor:"pointer",fontSize:12,fontWeight:500}}>
