            ...
            {MEAL_TYPES.map((mt,mi)=>{
              ...
              return <div key={mi} style={{marginBottom:8}}>
                ...
                {isEmptyMeal&&mealSugs.length>0&&<div style={{marginBottom:5}}>
                  ...
                  {expandedSugs[`${di}_${mi}`]&&<div style={{display:"flex",flexWrap:"wrap",gap:4}}>
                  {mealSugs.map(s=>(
...
function AppInner(){
  ...
  useEffect(()=>{
    ...
    s.textContent="html,body{overflow:hidden;overscroll-behavior:none;height:100%;position:fixed;width:100%;}*{-webkit-overflow-scrolling:touch;}input,textarea,select{font-size:16px;}";
